...
- (void)viewDidLoad {
    ...
    self.avatars = [Avatar allObjects];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *CellIdentifier = @"AvatarIdentifier";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (!cell) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }

    Avatar *avatar = self.avatars[indexPath.row];
    ...
    if ([self.selectedAvatars containsObject:avatar.avatarId]) {
        [self.selectedAvatars removeObject:avatar.avatarId];
        cell.accessoryType = UITableViewCellAccessoryCheckmark;
    } else {
        [self.selectedAvatars addObject:avatar.avatarId];
        cell.accessoryType = UITableViewCellAccessoryNone;
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    Avatar *selectedAvatar = (tableView == self.tableView) ?
        self.avatars[indexPath.row] : self.resultsTableController.filteredAvatars[indexPath.row];
    ...
    detailViewController.avatar = selectedAvatar; // hand off the current product to the detail view controller
...
- (void)updateSearchResultsForSearchController:(UISearchController *)searchController {
    ...
    RLMResults *searchResults = [Avatar objectsWhere:@"displayName CONTAINS[c] %@",strippedString];
    ...
    */
    ...
    tableController.filteredAvatars = searchResults;
