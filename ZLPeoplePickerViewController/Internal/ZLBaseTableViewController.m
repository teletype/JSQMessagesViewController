...
- (void)configureCell:(UITableViewCell *)cell forContact:(APContact *)contact {
    ...
    if (contact.thumbnail)
        avatarImage = [JSQMessagesAvatarImageFactory avatarImageWithImage:contact.thumbnail
                                                    diameter:kJSQMessagesCollectionViewAvatarSizeDefault];
    else {
        
        NSMutableString *displayString = [NSMutableString stringWithString:@""];
        
        NSMutableArray *words = [[contact.compositeName componentsSeparatedByCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]] mutableCopy];
        ...
        avatarImage = [JSQMessagesAvatarImageFactory avatarImageWithUserInitials:displayString
